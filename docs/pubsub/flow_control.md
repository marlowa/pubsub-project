...
[pubsub_requirements.md](../superseded/pubsub_requirements.md) (which frames the six dimensions) and
[dsl_topic_catalog.md](../superseded/dsl_topic_catalog.md) (topic identity). **Not yet implemented.**
