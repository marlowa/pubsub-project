...
Output lands in `<build-dir>/coverage_html/index.html`, generated by `gcovr` and post-processed
into `genhtml` form. Application code is excluded; the report covers the framework library.
