...
- [Testing and Code Coverage](../orientation/testing.md) — the report-not-gate principle these assertions follow
- [Metrics](metrics.md) — `order_round_trip_nanoseconds` and its bucket bounds
- [CPU Core Layout](../framework/cpu_pinning_anti_affinity.md) — why the cores must be quiet first, and cpu_audit.py
