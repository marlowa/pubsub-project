...
- [Socket Communications](../framework/socket_comms.md) — `ProtocolHandlerInterface`, `RawBytesProtocolHandler`, `MirroredBuffer`
- [Order Gateway](../venue/fix_order_gateway.md) — how the gateway initiates SCRAM and handles the result
