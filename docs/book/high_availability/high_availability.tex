...
\textbf{A requirement is stated of the venue} unless it is genuinely about a
particular component and would mean something different said of the venue.
...
it. Two are cited often enough to be worth stating once here:

\begin{itemize}[nosep]
  \item \textbf{BUG-0048} --- nothing bounds how far back the venue's record of
        what it did is kept. What survives is whatever has not yet been
        discarded, which varies with how busy the venue has been.
  \item \textbf{BUG-0064} --- a matching engine that starts without having been
        a follower applies nothing, so orders the venue took and had not yet
        given it are neither applied nor answered.
\end{itemize}
...
meet are different conditions, and only the second is a defect. \textbf{A requirement that nothing verifies is not an unfinished part of
