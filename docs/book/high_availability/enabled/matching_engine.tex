...
\begin{requirement}{R-0073}{An open order survives a failover}
  ...
  be recovered, and disclaim what cannot. That keeps what made cancelling
  attractive --- the member is told exactly where it stands --- without paying
  for it when the venue has the orders and knows it does.}
...
\begin{requirement}{R-0075}{The venue keeps working when the acting engine is lost}
  Members shall continue to be able to place and cancel orders across the loss of
  the instance that was acting.
  \covers{ha_test:16}
\end{requirement}
...
\begin{requirement}{R-0076}{Orders taken while no engine was acting are applied on promotion}
  ...
  once one is.
  \rationale{The venue took those orders, so it owes an answer for each. This is
