...
- [Compressed Trading Day Load Profile](../operations/trading_day_load.md) — the profile this would let FIX run
- [FIX Codec](codec.md) — the dictionary-driven codec to build on
- [Metrics](../operations/metrics.md) — `order_round_trip_nanoseconds` and the comparison view
- [CPU Core Layout](../framework/cpu_pinning_anti_affinity.md) — why both gateways share a rank group
