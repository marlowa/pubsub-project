...
- [WAL and High Availability](../design/wal_and_ha.md) — WAL format, two-tier commit, replication channel, failover
- [Architecture](../architecture.md) — full order flow and component topology
