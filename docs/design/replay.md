...
- [WAL and High Availability](wal_and_ha.md) — reconciliation, which is state reconstruction already
- [Pub/Sub](pubsub.md) — topic replay from a cursor, the nearest existing capability
- [Metrics](metrics.md) — the round-trip stamp and why replay drops it
