...
#define PUBSUB_LOG(logger_expr, log_level_expr, fmt, ...)                                                                                                      \
    do {                                                                                                                                                       \
        ...
        if (_pubsub_level == ::pubsub_itc_fw::FwLogLevel::Alert || _pubsub_level == ::pubsub_itc_fw::FwLogLevel::Critical) {                                   \
        ...
        } else if (_pubsub_level == ::pubsub_itc_fw::FwLogLevel::Notice || _pubsub_level == ::pubsub_itc_fw::FwLogLevel::Info) {                               \
