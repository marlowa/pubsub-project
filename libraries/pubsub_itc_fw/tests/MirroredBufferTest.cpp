 ...
 * fix_order_gateway under a multi-T burst from fix8.
 *
 ...
 * fix_order_gateway under a 1000-NewOrderSingle burst from fix8.
 *
 ...
 * scenario is tested end-to-end by running the fix_order_gateway
