...
/**
 * @brief Loads a FixOrderGatewayConfiguration from a TOML file.
 *
 ...
 */
class FixOrderGatewayConfigurationLoader {
  public:
    /**
     ...
     * @return Populated FixOrderGatewayConfiguration and created logger.
     * @throws pubsub_itc_fw::ConfigurationException on any error.
     */
    static std::tuple<FixOrderGatewayConfiguration, std::unique_ptr<pubsub_itc_fw::QuillLogger>> load_and_init_logging(const std::string& file_path,
