...
/**
 * @brief Loads a BinaryGatewayConfiguration from a TOML file.
 *
 ...
 */
class BinaryGatewayConfigurationLoader {
  public:
    /**
     ...
     * @return Populated BinaryGatewayConfiguration and the created logger.
     */
    static std::tuple<BinaryGatewayConfiguration, std::unique_ptr<pubsub_itc_fw::QuillLogger>> load_and_init_logging(const std::string& file_path,
