...
/**
 * @brief Loads a OrderGatewayConfiguration from a TOML file.
 *
 ...
 */
class OrderGatewayConfigurationLoader {
  public:
    /**
     ...
     * @return Populated OrderGatewayConfiguration and created logger.
     * @throws pubsub_itc_fw::ConfigurationException on any error.
     */
    static std::tuple<OrderGatewayConfiguration, std::unique_ptr<pubsub_itc_fw::QuillLogger>> load_and_init_logging(const std::string& file_path,
