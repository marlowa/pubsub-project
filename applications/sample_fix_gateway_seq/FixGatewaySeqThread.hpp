...
class FixGatewaySeqThread : public pubsub_itc_fw::ApplicationThread {
  ...
  private:
     ...
     * @param[in] in_msg  The inbound NewOrderSingle or OrderCancelRequest
     ...
     */
    void send_reject_execution_report(FixSession& session, const FixMessage& in_msg, const std::string& reason, bool is_cancel);
